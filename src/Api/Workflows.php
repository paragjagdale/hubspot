...
class Workflows extends Api
{
    ...
    {
        $endpoint = "/automation/v3/workflows/{$workflow_id}/enrollments/contacts/{$email}";
    ...
    {
        $endpoint = "/automation/v3/workflows/enrollments/contacts/{$contact_id}";
    ...
    {
        $endpoint = " /automation/v3/workflows/{$workflow_id}/logevents/contacts/{$contact_id}/past";
    ...
    {
        $endpoint = "/automation/v3/workflows/{$workflow_id}/logevents/contacts/{$contact_id}/upcoming";
